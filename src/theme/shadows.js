...
const createCustomShadow = (color) => {
  ...
  return {
    ...
    primary: `0px 3px 8px ${alpha(palette.light.primary.main, 0.34)}`,
    secondary: `0px 3px 8px ${alpha(palette.light.secondary.main, 0.34)}`,
    info: `0px 3px 8px ${alpha(palette.light.info.main, 0.34)}`,
    success: `0px 3px 8px ${alpha(palette.light.success.main, 0.34)}`,
    warning: ` 0px 3px 8px ${alpha(palette.light.warning.main, 0.34)}`,
    error: ` 0px 3px 8px ${alpha(palette.light.error.main, 0.34)}`,
  };
};
// type error
